...
abstract contract MercuryGameBase is ERC1155Holder {
    ...
    function approveForGame(address payable burner, uint256 tokenId, MercuryBase aviation) public payable virtual {
    ...
    function batchUnApproveForGame(uint256[] memory tokenIds, MercuryBase aviation) public onlyOwner {
