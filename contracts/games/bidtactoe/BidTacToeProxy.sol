...
contract BidTacToeProxy {
    ...
    //base goerli chain
    address constant BidTacToePlayerVersusBot = address(0x6b58b7e6800CCa519bd11380a5CdABbc83B70C8B);
    address constant BidTacToe = address(0xc6B4AF6B7C944a4C43755b83753D292Ac3447b19);
