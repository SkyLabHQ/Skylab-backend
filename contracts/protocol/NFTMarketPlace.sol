...
import "../libraries/NFTCommon.sol";
...
contract Marketplace is IMarketplace {
    ...
    function createBid(
        ...
        require(totalPrice == msg.value,  "Marketplace::insufficient ether sent");
    }
        ...
        override
    {
        ...
        for (uint256 i = 0; i < nft.length; i++) {
            ...
            require(success, "Marketplace::NFT not sent");

            delete asks[nftAddress][tokenID[i]];
        }

        require(totalPrice == msg.value, "Marketplace::ask price higher than sent value");
    }
